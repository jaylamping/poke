...
#define PARTY_LAYOUT_HOENN_SINGLE 0
#define PARTY_LAYOUT_HOENN_DOUBLE 1
#define PARTY_LAYOUT_HOENN_MULTI 2
#define PARTY_LAYOUT_HOENN_MULTI_SHOWCASE 3 // The layout during the screen that appears just before a multi battle
#define PARTY_LAYOUT_HOENN_COUNT 4
