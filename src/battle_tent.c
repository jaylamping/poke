...
{
    return gMapHeader.regionMapSectionId == MAPSEC_SLATEPORT_CITY && (gMapHeader.mapLayoutId == LAYOUT_HOENN_BATTLE_TENT_CORRIDOR || gMapHeader.mapLayoutId == LAYOUT_HOENN_BATTLE_TENT_BATTLE_ROOM);
}
